// Cada razón ahora incluye: categoría, fórmula en texto, y los rangos
// descritos en texto (para mostrarlos en el PDF), además de las
// funciones de evaluación reales.
...
export function calcularRazones(datos) {
    ...
    razones.push(evaluar({
        ...
        valor: costoVentas / (inventarioPromedio || inventarios),
        formato: 'veces',
    ...
    razones.push(evaluar({
        ...
        valor: (ventasCredito || ventasNetas) / (cuentasPorCobrarPromedio || cuentasPorCobrar),
        formato: 'veces',
    ...
    razones.push(evaluar({
        ...
        valor: utilidadNeta / activoTotal,
        formato: 'porcentaje',
...
export function resumenGeneral(razones) {
    ...
    const porcentajeSalud = puntajeTotal / puntajeMaximo

    let veredicto = 'La empresa muestra señales de alerta importantes en varios indicadores financieros.'
    if (porcentajeSalud >= 0.75) veredicto = 'La empresa muestra una salud financiera sólida en la mayoría de los indicadores evaluados.'
    else if (porcentajeSalud >= 0.5) veredicto = 'La empresa muestra una salud financiera aceptable, con áreas de oportunidad claras.'
