        ...
        <div class="dsc-filters">
            <div class="dsc-filters__row dsc-filters__row--header">
                <div class="dsc-header-info">
                    ...
                    <div>
                        <div class="dsc-header-title">Constancia de Situación Fiscal</div>
                        <div class="dsc-header-subtitle">
                            Solicita y consulta el historial de descargas ante el SAT
                        </div>
                    </div>
                </div>

                <div class="dsc-field dsc-field--btns">
                    <q-btn dense unelevated color="primary" icon="mdi-cloud-download" label="Solicitar Constancia"
                        :loading="cargandoSolicitud" :disable="cargandoSolicitud" class="dsc-btn"
            ...
            <div v-if="hayEnProceso" class="dsc-alert dsc-alert--blue">
                ...
                <span>Hay una solicitud en proceso — el estatus se actualizará automáticamente cada 2
                    minutos.</span>
            </div>
        </div>
            ...
            <q-table dense flat bordered :data="registrosFiltrados" :columns="columns" :filter="filter"
                ...
                <template v-slot:top>
                    <div class="dsc-table__top">
                        <span class="dsc-table__title">Historial Constancia Fiscal</span>
                ...
                <template v-slot:body="props">
                    <q-tr :props="props" :class="rowClass(props.row)">
                        ...
                        <q-td key="nombreArchivo" :props="props" class="dsc-td">{{
                        ...
                        <q-td key="acciones" :props="props" class="dsc-td" auto-width>
                            <div class="dsc-actions">
                                ...
                                <q-btn v-else-if="props.row.estado === 'COMPLETADO'" dense round flat size="md"
                                    color="teal" icon="mdi-download" :href="obtenerUrlArchivo(props.row.id)"
                                    target="_blank">
...
export default {
    name: "ConstanciaFiscalPage",
    data() {
        return {
            tipoDocumento: "constancia",
            endpointSolicitud: "DescargarConstancia",
