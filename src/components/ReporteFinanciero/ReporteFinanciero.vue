<template>
    <div class=" rg-page">
        ...
        <q-card flat class="rg-card rg-card--header q-mb-lg full-width ">
            <q-card-section>
                <div class="row items-start q-col-gutter-md">
                    <div class="col-12 col-sm-8">
                        ...
                        <div class="rg-period" v-if="periodoValido">
                            ...
                            {{ obtenerNombreMes(mesIValue) }} — {{ obtenerNombreMes(mesFValue) }} {{ anio }}
                        </div>
                ...
                <div class="row q-col-gutter-sm">
                    <div class="col-auto" v-for="(val, key) in mostrarSecciones" :key="key">
                        <q-chip
                            clickable
                            :selected="mostrarSecciones[key]"
                            :class="['rg-chip', `rg-chip--${key}`, { 'rg-chip--active': mostrarSecciones[key] }]"
                            :icon="mostrarSecciones[key] ? 'check_circle' : 'radio_button_unchecked'"
        ...
        <div v-if="reporteGenerado">
            ...
            <div class="row q-col-gutter-md q-mb-lg">
                ...
                <div class="col-6 col-md-3">
                    <div class="rg-kpi rg-kpi--flujo">
                        ...
                        <div class="rg-kpi__value">{{ formatoPesos(totalDiferenciaFlujo) }}</div>
                    </div>
                </div>
            </div>

            <!-- ===================== COMPROBANTES EMITIDOS POR RFC ===================== -->
            <q-card flat class="rg-card rg-section rg-section--emitidos q-mb-md full-width" v-if="mostrarSecciones.emitidos">
                <q-card-section class="rg-section__header">
                    ...
                    <div>
                        ...
                        <div class="rg-section__subtitle">{{ tablaComprobantesEmitidos.length }} registros</div>
                    </div>
                </q-card-section>
                <q-table
                ...
                >
                    <template v-slot:body-cell-importeI="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.importeI) }}</q-td>
                    </template>
                    <template v-slot:body-cell-importeE="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.importeE) }}</q-td>
                    </template>
                </q-table>
            </q-card>

            <!-- ===================== COMPROBANTES RECIBIDOS POR RFC ===================== -->
            <q-card flat class="rg-card rg-section rg-section--recibidos q-mb-md full-width" v-if="mostrarSecciones.recibidos">
                <q-card-section class="rg-section__header">
                    <q-icon name="south_west" class="rg-section__icon" />
                    <div>
                        <div class="rg-section__title">Comprobantes Recibidos por RFC</div>
                        <div class="rg-section__subtitle">{{ tablaComprobantesRecibidos.length }} registros</div>
                    </div>
                </q-card-section>
                <q-table
            ...
            <!-- ===================== NOMINA - IMPORTES ===================== -->
            <q-card flat class="rg-card rg-section rg-section--nomina q-mb-md full-width" v-if="mostrarSecciones.nomina">
                <q-card-section class="rg-section__header">
                ...
                >
                    <template v-slot:body-cell-percepciones="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.percepciones) }}</q-td>
                    </template>
                    <template v-slot:body-cell-deducciones="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.deducciones) }}</q-td>
                    </template>
                    <template v-slot:body-cell-otrosPagos="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.otrosPagos) }}</q-td>
                    </template>
                    <template v-slot:body-cell-total="props">
                        <q-td :props="props" class="rg-cell-money rg-cell-strong">{{ formatoPesos(props.row.total) }}</q-td>
                    </template>
                </q-table>
                    ...
                    >
                        ...
                        >
                            <template v-slot:body-cell-importe="props">
                                <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.importe) }}</q-td>
                            </template>
                        </q-table>
                        <div v-else class="rg-empty-note">
                            Sin conceptos para este mes.
                        </div>
                    </q-expansion-item>
                </q-card-section>
            </q-card>
            ...
            <!-- ===================== CUENTAS POR COBRAR ===================== -->
            <q-card flat class="rg-card rg-section rg-section--cxc q-mb-md full-width" v-if="mostrarSecciones.cxc">
                <q-card-section class="rg-section__header">
                    <q-icon name="account_balance_wallet" class="rg-section__icon" />
                    <div>
                        <div class="rg-section__title">Cuentas por Cobrar</div>
                        <div class="rg-section__subtitle">{{ tablaCxC.length }} comprobantes</div>
                    </div>
                </q-card-section>
                <q-table
                    :data="tablaCxC"
                ...
                >
                    <template v-slot:body-cell-porCobrar="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.porCobrar, props.row.moneda) }}</q-td>
                    </template>
                    <template v-slot:body-cell-cobrado="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.cobrado, props.row.moneda) }}</q-td>
                    </template>
                    <template v-slot:body-cell-total="props">
                    ...
                    <template v-slot:body-cell-dias="props">
                        <q-td :props="props">
                            <q-badge :color="colorDias(props.row.dias)" class="rg-badge">{{ props.row.dias }} días</q-badge>
                        </q-td>
                    </template>
                </q-table>
            </q-card>
            ...
            <!-- ===================== CUENTAS POR PAGAR ===================== -->
            <q-card flat class="rg-card rg-section rg-section--cxp q-mb-md full-width" v-if="mostrarSecciones.cxp">
                <q-card-section class="rg-section__header">
                    <q-icon name="credit_card" class="rg-section__icon" />
                    <div>
                        <div class="rg-section__title">Cuentas por Pagar</div>
                        <div class="rg-section__subtitle">{{ tablaCxP.length }} comprobantes</div>
                    </div>
                </q-card-section>
                <q-table
                    :data="tablaCxP"
                ...
                >
                    <template v-slot:body-cell-porPagar="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.porPagar, props.row.moneda) }}</q-td>
                    </template>
                    <template v-slot:body-cell-pagado="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.pagado, props.row.moneda) }}</q-td>
                    </template>
                    <template v-slot:body-cell-total="props">
                        <q-td :props="props" class="rg-cell-money rg-cell-strong">{{ formatoPesos(props.row.total, props.row.moneda) }}</q-td>
                    </template>
            ...
            <q-card flat class="rg-card rg-section rg-section--flujo q-mb-md full-width" v-if="mostrarSecciones.flujo">
                <q-card-section class="rg-section__header">
                    <q-icon name="swap_horiz" class="rg-section__icon" />
                    <div>
                        <div class="rg-section__title">Comparativa de Flujo (PUE)</div>
                        <div class="rg-section__subtitle">Emitido vs. recibido, por moneda</div>
                    </div>
                </q-card-section>

                <template v-if="comparativaFlujoPorMoneda.length > 0">
                    <div v-for="(grupo, idx) in comparativaFlujoPorMoneda" :key="grupo.moneda">
                        ...
                        >
                            <template v-slot:body-cell-totalEPUE="props">
                                <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.totalEPUE, props.row.moneda) }}</q-td>
                            </template>
                            <template v-slot:body-cell-totalRPUE="props">
                                <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.totalRPUE, props.row.moneda) }}</q-td>
                            </template>
                            <template v-slot:body-cell-diferenciaPUE="props">
                                <q-td :props="props" class="rg-cell-money rg-cell-strong">
                                    <span :class="props.row.diferenciaPUE >= 0 ? 'rg-positive' : 'rg-negative'">
                                        {{ formatoPesos(props.row.diferenciaPUE, props.row.moneda) }}
                                    </span>
                                </q-td>
                            </template>
                        </q-table>
                        <q-separator v-if="idx < comparativaFlujoPorMoneda.length - 1" class="rg-separator q-my-sm" />
                    </div>
                </template>
            ...
            <!-- ===================== USO DE CFDI ===================== -->
            <q-card flat class="rg-card rg-section rg-section--usocfdi q-mb-md full-width" v-if="mostrarSecciones.usoCfdi">
                <q-card-section class="rg-section__header">
                    <q-icon name="sell" class="rg-section__icon" />
                    <div>
                        <div class="rg-section__title">Reporte por Uso de CFDI</div>
                        <div class="rg-section__subtitle">Emitidos / Recibidos / Nómina por clave de uso</div>
                    </div>
                </q-card-section>
                <q-table
                ...
                >
                    <template v-slot:body-cell-emitidos="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.emitidos) }}</q-td>
                    </template>
                    <template v-slot:body-cell-recibidos="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.recibidos) }}</q-td>
                    </template>
                    <template v-slot:body-cell-nomina="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.nomina) }}</q-td>
                    </template>
                </q-table>
                <q-card-section v-else class="rg-empty-note">
                    Sin datos de uso de CFDI para el periodo seleccionado.
                </q-card-section>
                <q-card-section v-if="tablaUsoCfdi.length > 0" class="rg-currency-header justify-end">
                    Diferencia (Emitidos − Recibidos − Nómina): {{ formatoPesos(diferenciaUsoCfdi) }}
                </q-card-section>
            </q-card>

            <!-- ===================== COMPARATIVA ANUAL ===================== -->
            <q-card flat class="rg-card rg-section rg-section--comparativaanual q-mb-md full-width" v-if="mostrarSecciones.comparativaAnual">
                <q-card-section class="rg-section__header">
                    <q-icon name="fact_check" class="rg-section__icon" />
                    <div>
                        <div class="rg-section__title">Comparativa Anual</div>
                        <div class="rg-section__subtitle">Determinado (Uso de CFDI {{ anio }}) vs. Declarado (Declaración Anual SAT)</div>
                    </div>
                </q-card-section>
                ...
                >
                    <template v-slot:body-cell-determinado="props">
                        <q-td :props="props" class="rg-cell-money">
                            <span v-if="props.row.tipo === 'porcentaje'">{{ formatoPorcentaje(props.row.determinado * 100) }}</span>
                            <span v-else>{{ formatoPesos(props.row.determinado) }}</span>
                        </q-td>
                    </template>
                    <template v-slot:body-cell-declarado="props">
                        <q-td :props="props" class="rg-cell-money">
                            <span v-if="props.row.declarado === null || props.row.declarado === undefined">—</span>
                            <span v-else-if="props.row.tipo === 'porcentaje'">{{ formatoPorcentaje(props.row.declarado * 100) }}</span>
                            <span v-else>{{ formatoPesos(props.row.declarado) }}</span>
                        </q-td>
                    </template>
                    <template v-slot:body-cell-diferencia="props">
                        <q-td :props="props" class="rg-cell-money rg-cell-strong">
                            <span v-if="props.row.diferencia === null || props.row.diferencia === undefined">—</span>
                            <span v-else-if="props.row.tipo === 'porcentaje'" :class="Math.abs(props.row.diferencia) < 0.0001 ? '' : (props.row.diferencia >= 0 ? 'rg-positive' : 'rg-negative')">
                                {{ formatoPorcentaje(props.row.diferencia * 100) }}
                            </span>
                            <span v-else :class="Math.abs(props.row.diferencia) < 1 ? '' : (props.row.diferencia >= 0 ? 'rg-positive' : 'rg-negative')">
                ...
                <q-card-section v-if="comparativaAnualMensaje" class="rg-empty-note">
                    <q-icon name="info" size="16px" class="q-mr-xs" />{{ comparativaAnualMensaje }}
                </q-card-section>
            </q-card>
            ...
            <q-card flat class="rg-card rg-section rg-section--pagosiva q-mb-md full-width" v-if="mostrarSecciones.pagosIva">
                <q-card-section class="rg-section__header">
                    ...
                    <div>
                        ...
                        <div class="rg-section__subtitle">Enero — {{ obtenerNombreMes(mesFValue) }} {{ anio }} (acumulado)</div>
                    </div>
                </q-card-section>
                <q-table
                ...
                >
                    <template v-slot:body-cell-baseIvaTrasladado="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.baseIvaTrasladado) }}</q-td>
                    </template>
                    <template v-slot:body-cell-importeIvaTrasladado="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.importeIvaTrasladado) }}</q-td>
                    </template>
                    <template v-slot:body-cell-baseIvaAcreditado="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.baseIvaAcreditado) }}</q-td>
                    </template>
                    <template v-slot:body-cell-importeIvaAcreditado="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.importeIvaAcreditado) }}</q-td>
                    </template>
                    <template v-slot:body-cell-ivaRetenido="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.ivaRetenido) }}</q-td>
                    </template>
                    <template v-slot:body-cell-ivaRetenidoAnterior="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.ivaRetenidoAnterior) }}</q-td>
                    </template>
                    <template v-slot:body-cell-ivaCargo="props">
                        <q-td :props="props" class="rg-cell-money rg-cell-strong">
                            <span class="rg-negative">{{ formatoPesos(props.row.ivaCargo) }}</span>
                        </q-td>
                    </template>
                    <template v-slot:body-cell-ivaFavor="props">
                        <q-td :props="props" class="rg-cell-money rg-cell-strong">
                            <span class="rg-positive">{{ formatoPesos(props.row.ivaFavor) }}</span>
                        </q-td>
                    </template>
                    <template v-slot:body-cell-cargoRegistrado="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.cargoRegistrado) }}</q-td>
                    </template>
                    <template v-slot:body-cell-favorRegistrado="props">
                        <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.favorRegistrado) }}</q-td>
                    </template>
                    <template v-slot:body-cell-comparativa="props">
                        <q-td :props="props" class="rg-cell-money rg-cell-strong">
                            <span :class="props.row.comparativa >= 0 ? 'rg-positive' : 'rg-negative'">
            ...
            <!-- ===================== RETENCIONES DE ISR ===================== -->
            <q-card flat class="rg-card rg-section rg-section--pagosisr q-mb-md full-width" v-if="mostrarSecciones.pagosIsr">
                <q-card-section class="rg-section__header">
                ...
                <div v-for="(cat, idx) in categoriasIsr" :key="cat.key">
                    ...
                    >
                        ...
                        <template v-slot:body-cell-comparativa="props">
                            <q-td :props="props" class="rg-cell-money">{{ formatoPesos(props.row.comparativa) }}</q-td>
                        </template>
                        <template v-slot:body-cell-diferencia="props">
                            <q-td :props="props" class="rg-cell-money rg-cell-strong">
                                <span :class="props.row.diferencia >= 0 ? 'rg-positive' : 'rg-negative'">
                                    {{ formatoPesos(props.row.diferencia) }}
                                </span>
                            </q-td>
                        </template>
                    ...
                    <q-separator v-if="idx < categoriasIsr.length - 1" class="rg-separator q-my-sm" />
                </div>
            </q-card>

            <!-- ===================== PAGOS PROVISIONALES DE ISR ===================== -->
            <q-card flat class="rg-card rg-section rg-section--pp q-mb-md full-width" v-if="mostrarSecciones.pagosProvisionales">
                <q-card-section class="rg-section__header">
                    <q-icon name="account_balance" class="rg-section__icon" />
                    <div>
                        <div class="rg-section__title">Pagos Provisionales de ISR</div>
                        <div class="rg-section__subtitle" v-if="tablaPagosProvisionales.regimenLabel">
                            {{ tablaPagosProvisionales.regimenLabel }} · Enero — {{ obtenerNombreMes(mesFValue) }} {{ anio }}
                        </div>
                ...
                >
                    <template v-slot:body="props">
                        <q-tr :props="props">
                            ...
                            >
                                <span v-if="col.tipo === 'moneda'">{{ formatoPesos(props.row[col.field]) }}</span>
                                <span v-else-if="col.tipo === 'porcentaje'">{{ formatoPorcentaje(props.row[col.field]) }}</span>
                ...
                <q-card-section v-else class="rg-empty-note">
                    {{ tablaPagosProvisionales.mensaje || "Sin datos de pagos provisionales para el periodo seleccionado." }}
                </q-card-section>
            </q-card>
...
export default {
    ...
    data() {
        return {
            ...
            columnasUsoCfdi: [
                ...
                { name: "emitidos", label: "Emitidos", field: "emitidos", align: "right" },
            ...
            columnasComparativaAnual: [
                { name: "concepto", label: "Declaración Anual", field: "concepto", align: "left" },
                { name: "determinado", label: "Determinado", field: "determinado", align: "right" },
            ...
            columnasComprobantesRfc: [
                ...
                { name: "ingresos", label: "# Ingresos", field: "ingresos", align: "center", sortable: true },
                { name: "importeI", label: "Importe Ingresos", field: "importeI", align: "right", sortable: true },
                { name: "egresos", label: "# Egresos", field: "egresos", align: "center", sortable: true },
                { name: "importeE", label: "Importe Egresos", field: "importeE", align: "right", sortable: true },
            ],
            columnasNomina: [
                { name: "mes", label: "Mes", field: "mes", align: "left" },
                { name: "contador", label: "# Trabajadores", field: "contador", align: "center" },
                { name: "percepciones", label: "Percepciones", field: "percepciones", align: "right" },
                { name: "deducciones", label: "Deducciones", field: "deducciones", align: "right" },
                { name: "otrosPagos", label: "Otros Pagos", field: "otrosPagos", align: "right" },
                { name: "total", label: "Total", field: "total", align: "right" },
            ],
            columnasConceptosNomina: [
                { name: "claveSat", label: "Clave SAT", field: "claveSat", align: "left" },
            ...
            columnasCxC: [
                ...
                { name: "porCobrar", label: "Por Cobrar", field: "porCobrar", align: "right" },
                { name: "cobrado", label: "Cobrado", field: "cobrado", align: "right" },
                { name: "total", label: "Total", field: "total", align: "right" },
                { name: "moneda", label: "Moneda", field: "moneda", align: "center" },
                { name: "dias", label: "Días de Crédito", field: "dias", align: "center" },
            ],
            columnasCxP: [
                { name: "serie", label: "Serie", field: "serie", align: "center" },
                { name: "folio", label: "Folio", field: "folio", align: "center" },
                ...
                { name: "rfc", label: "RFC", field: "rfc", align: "left" },
                { name: "nombre", label: "Nombre", field: "nombre", align: "left" },
                { name: "porPagar", label: "Por Pagar", field: "porPagar", align: "right" },
            ...
            columnasComparativaFlujo: [
                { name: "mes", label: "Mes", field: "mes", align: "left" },
                { name: "totalEPUE", label: "Emitido PUE", field: "totalEPUE", align: "right" },
                { name: "totalRPUE", label: "Recibido PUE", field: "totalRPUE", align: "right" },
                { name: "diferenciaPUE", label: "Diferencia", field: "diferenciaPUE", align: "right" },
            ],
            columnasPagosIsr: [
                { name: "mes", label: "Mes", field: "mes", align: "left" },
                { name: "importe", label: "Importe", field: "importe", align: "right" },
                { name: "comparativa", label: "Comparativa", field: "comparativa", align: "right" },
                { name: "diferencia", label: "Diferencia", field: "diferencia", align: "right" },
            ],
        };
    },
    computed: {
        ...
        mesIValue() {
            return this.mesI && typeof this.mesI === "object" ? this.mesI.value : this.mesI;
        },
        mesFValue() {
            return this.mesF && typeof this.mesF === "object" ? this.mesF.value : this.mesF;
        },
        periodoValido() {
        ...
        totalIngresos() {
            return this.tablaComprobantesEmitidos.reduce((acc, r) => acc + (r.importeI || 0), 0);
        },
        totalEgresos() {
            return this.tablaComprobantesRecibidos.reduce((acc, r) => acc + (r.importeI || 0), 0);
        },
        totalNomina() {
            return this.tablaNominas.reduce((acc, r) => acc + (r.total || 0), 0);
        },
        totalDiferenciaFlujo() {
            return this.tablaComparativaFlujo.reduce((acc, r) => acc + (r.diferenciaPUE || 0), 0);
        },
        diferenciaUsoCfdi() {
            return this.tablaUsoCfdi.reduce(
                (acc, r) => acc + (r.emitidos || 0) - (r.recibidos || 0) - (r.nomina || 0),
                0
            );
        },
        ...
        comparativaFlujoPorMoneda() {
            ...
            return Object.keys(grupos)
                ...
                .map((moneda) => ({
                    moneda,
                    filas: grupos[moneda].slice().sort(
        ...
        columnasPagosIva() {
            const cols = [
                { name: "mes", label: "Mes", field: "mes", align: "left" },
                { name: "baseIvaTrasladado", label: "Base IVA Trasladado", field: "baseIvaTrasladado", align: "right" },
                { name: "importeIvaTrasladado", label: "Importe IVA Trasladado", field: "importeIvaTrasladado", align: "right" },
                { name: "baseIvaAcreditado", label: "Base IVA Acreditado", field: "baseIvaAcreditado", align: "right" },
                { name: "importeIvaAcreditado", label: "Importe IVA Acreditado", field: "importeIvaAcreditado", align: "right" },
                { name: "ivaRetenido", label: "IVA Retenido", field: "ivaRetenido", align: "right" },
            ];
            ...
            cols.push(
                { name: "ivaCargo", label: "IVA a Cargo", field: "ivaCargo", align: "right" },
                { name: "ivaFavor", label: "IVA a Favor", field: "ivaFavor", align: "right" },
                { name: "cargoRegistrado", label: "Cargo Registrado", field: "cargoRegistrado", align: "right" },
                { name: "favorRegistrado", label: "Favor Registrado", field: "favorRegistrado", align: "right" },
                { name: "comparativa", label: "Comparativa", field: "comparativa", align: "right" }
            );
            return cols;
        },
    ...
    methods: {
        ...
        async GetReporteFlujo(rfc, tipo, año, mesI, mesF) {
            try {
                ...
                data.forEach((mes) => {
                    ...
                    if (Object.keys(datosPorMoneda).length > 0) datosFinales.push(datosPorMoneda);
                });
                return datosFinales;
            } catch (error) {
                console.log(error);
                ...
                lista.forEach((item) => {
                    Object.keys(item).forEach((moneda) => {
                        item[moneda].forEach((reg) => {
                            ...
                            if (!resultado[key]) {
                                resultado[key] = { moneda, mes: reg.mes, totalEPUE: 0, totalRPUE: 0 };
                            }
        ...
        async ivaGetComparativa(rfc, año, tipo) {
            ...
            const respuestaDefault = meses.map((mes) => ({ mes, importe: 0, ivaCargo: 0, ivaFavor: 0 }));
            try {
                const response = await axios.get(
        ...
        async ivaCalcularMoralesLegacy(rfc, año, mesFValue, ivaCargo) {
            const resultado = [];
            try {
                const ivaAcreditable = await this.ivaGetAcreditadoLegacy(rfc, año, mesFValue);
                ...
                for (let x = 0; x < mesFValue; x++) {
                    ...
                    const calculo = ivaCargo_ - ivaAcreditado_ - ivaRetenido_ + ivaRetenidoAnterior_;
                    if (calculo > 0) {
        ...
        async ivaCalcularFisicasLegacy(rfc, año, mesFValue, ivaCargo) {
            ...
            try {
                const ivaAcreditable = await this.ivaGetAcreditadoLegacy(rfc, año, mesFValue);
                const ivaRetenido = await this.ivaGetRetenidoNeteado(rfc, año, mesFValue);
                const comparativa = await this.ivaGetComparativa(rfc, año, "IVA");
                if (!ivaAcreditable || !ivaRetenido || !comparativa) return resultado;
        ...
        async ivaCalcularMoralesNuevo(rfc, año, mesFValue) {
            ...
            try {
                const fechaI = `${año}-01-01`;
                const fechaF = `${año}-${mesFValue}-01`;
                const emitidos = (await this.ivaGetEmitidosCompleto(rfc, fechaI, fechaF)) || [];
                const recibidos = (await this.ivaGetRecibidosCompleto(rfc, fechaI, fechaF)) || [];
                const ivaRet = (await this.ivaGetRetenido(rfc, año, mesFValue)) || [];
                const ivaRetEmitido = (await this.ivaGetRetenidoNeteado(rfc, año, mesFValue)) || [];
                ...
                for (let x = 0; x < mesFValue; x++) {
                    ...
                    const ivaRetenidoE = ivaRetEmitido
                        .filter((i) => i.mes?.toUpperCase() === mes && i.año === año)
                        .reduce((a, i) => a + (i.importeIva || 0), 0);
                    const ivaRetenidoAnterior = (ivaRet[x]?.importeIva || 0) + ivaRetenidoE;
        ...
        async ivaCalcularFisicasNuevo(rfc, año, mesFValue) {
            ...
            try {
                ...
                const emitidos = (await this.ivaGetEmitidosCompleto(rfc, fechaI, fechaF)) || [];
                const recibidos = (await this.ivaGetRecibidosCompleto(rfc, fechaI, fechaF)) || [];
                const ivaRet = (await this.ivaGetRetenidoNeteado(rfc, año, mesFValue)) || [];
                const comp = (await this.ivaGetComparativa(rfc, año, "IVA")) || [];
        ...
        isrConstruirFila(arr, comp, mesFValue) {
            ...
            for (let a = 0; a < mesFValue; a++) {
                const base = (arr && arr[a]) || { mes: this.obtenerNombreMes(a + 1), importe: 0 };
        ...
        async isrGetPagosReporte(rfc, año, mesFValue) {
            const vacio = {
                sueldos: [], asimilados: [], otros: [],
                arrendamientos: [], honorarios: [], demasIngresos: [],
                isrRetenidoFavor: [],
            };
            ...
            try {
                ...
                const sueldos = this.isrConstruirFila(nomina && nomina[0], compSueldos, mesFValue);
                const asimilados = this.isrConstruirFila(nomina && nomina[1], compAsimilados, mesFValue);
                const otros = this.isrConstruirFila(nomina && nomina[2], compOtros, mesFValue);
                const arrendamientos = this.isrConstruirFila(gastos && gastos[0], compArrendamientos, mesFValue);
                const honorarios = this.isrConstruirFila(gastos && gastos[1], compHonorarios, mesFValue);
                const demasIngresos = this.isrConstruirFila(gastos && gastos[2], compDemasIngresos, mesFValue);
                ...
                for (let m = 1; m <= mesFValue; m++) {
                    ...
                    const importeComparativa = (compIsrFavor && compIsrFavor[m - 1] && compIsrFavor[m - 1].importe) || 0;
                ...
                return { sueldos, asimilados, otros, arrendamientos, honorarios, demasIngresos, isrRetenidoFavor };
            } catch (error) {
                console.log(error);
                return vacio;
            }
        ...
        async ppIsrCalcularGeneralMoral(rfc, año, mesFValue) {
            const columnas = [
                { name: "mes", label: "Mes", field: "mes", align: "left", tipo: "texto" },
                { name: "ingresosPorMes", label: "Ingresos por Mes", field: "ingresosPorMes", align: "right", tipo: "moneda" },
                { name: "ingresosAcumulados", label: "Ingresos Acumulados", field: "ingresosAcumulados", align: "right", tipo: "moneda" },
                { name: "utilidadFiscal", label: "Utilidad Fiscal", field: "utilidadFiscal", align: "right", tipo: "moneda" },
                { name: "basePagoProvisional", label: "Base Pago Provisional", field: "basePagoProvisional", align: "right", tipo: "moneda" },
                { name: "pagoProvisional", label: "Pago Provisional", field: "pagoProvisional", align: "right", tipo: "moneda" },
                { name: "impuestoCargo", label: "Impuesto a Cargo", field: "impuestoCargo", align: "right", tipo: "moneda" },
                { name: "impuestoregistrado", label: "Impuesto Registrado", field: "impuestoregistrado", align: "right", tipo: "moneda" },
                { name: "comparativa", label: "Comparativa", field: "comparativa", align: "right", tipo: "moneda" },
            ];
            const filas = [];
            try {
                const ingresos = (await this.ppIsrGetIngresosFacturados(rfc, año, mesFValue)) || [];
                const coeficiente = (await this.ivaGetComparativa(rfc, año, "Coeficiente")) || [];
                const perdida = (await this.ivaGetComparativa(rfc, año, "Perdida")) || [];
                const registrados = (await this.ivaGetComparativa(rfc, año, "RegistradosPPIsr")) || [];

                let acumulado = 0;
                let pagoAnterior = 0;

                for (let i = 0; i < mesFValue; i++) {
                    const ing = ingresos[i] || { mes: this.obtenerNombreMes(i + 1), importe: 0 };
                    ...
                    fila.utilidadFiscal = acumulado * ((coeficiente[i] && coeficiente[i].importe) || 0);
                    let base = fila.utilidadFiscal - ((perdida[i] && perdida[i].importe) || 0);
                    if (base < 0) base = 0;
                    ...
                    fila.impuestoregistrado = (registrados[i] && registrados[i].importe) || 0;
        ...
        async ppIsrCalcularFisicaActividadEmpresarial(rfc, año, mesFValue) {
            const columnas = [
                ...
                { name: "ingresosPorMes", label: "Ingresos por Mes", field: "ingresosPorMes", align: "right", tipo: "moneda" },
                { name: "ingresosAcumulados", label: "Ingresos Acumulados", field: "ingresosAcumulados", align: "right", tipo: "moneda" },
                { name: "gastosPorMes", label: "Gastos por Mes", field: "gastosPorMes", align: "right", tipo: "moneda" },
                { name: "gastosAcumulados", label: "Gastos Acumulados", field: "gastosAcumulados", align: "right", tipo: "moneda" },
                { name: "baseCalculo", label: "Base del Cálculo", field: "baseCalculo", align: "right", tipo: "moneda" },
                { name: "limiteInferior", label: "Límite Inferior", field: "limiteInferior", align: "right", tipo: "moneda" },
                { name: "baseImpuesto", label: "Base Impuesto", field: "baseImpuesto", align: "right", tipo: "moneda" },
                { name: "porcentaje", label: "Porcentaje", field: "porcentaje", align: "right", tipo: "porcentaje" },
                { name: "impuestoMarginal", label: "Impuesto Marginal", field: "impuestoMarginal", align: "right", tipo: "moneda" },
                { name: "cuotaFija", label: "Cuota Fija", field: "cuotaFija", align: "right", tipo: "moneda" },
                { name: "importeIsr", label: "Importe ISR", field: "importeIsr", align: "right", tipo: "moneda" },
                { name: "pagosAnteriores", label: "Pagos Anteriores", field: "pagosAnteriores", align: "right", tipo: "moneda" },
                { name: "isrCargo", label: "ISR a Cargo", field: "isrCargo", align: "right", tipo: "moneda" },
                { name: "isrEmitido", label: "ISR Retenido", field: "isrEmitido", align: "right", tipo: "moneda" },
                { name: "isrPagar", label: "ISR a Pagar", field: "isrPagar", align: "right", tipo: "moneda" },
                { name: "impuestoregistrado", label: "Impuesto Registrado", field: "impuestoregistrado", align: "right", tipo: "moneda" },
                { name: "comparativa", label: "Comparativa", field: "comparativa", align: "right", tipo: "moneda" },
            ];
            const filas = [];
            try {
                const tablas = await this.ppIsrGetTablas(año, "personas_fisicas_actividad_empresarial", "mensual");
                const ingresos = (await this.ppIsrGetIngresosCobrados(rfc, año, mesFValue)) || [];
                const gastos = (await this.ppIsrGetGastosPagados(rfc, año, mesFValue)) || [];
                const registrados = (await this.ivaGetComparativa(rfc, año, "RegistradosPPIsr")) || [];
                const isrEmitido = (await this.isrGetRetenidoFavor(rfc, año, mesFValue)) || [];
        ...
        async ppIsrCalcularResicoFisica(rfc, año, mesFValue) {
            const columnas = [
                { name: "mes", label: "Mes", field: "mes", align: "left", tipo: "texto" },
                { name: "ingresosPorMes", label: "Ingresos por Mes", field: "ingresosPorMes", align: "right", tipo: "moneda" },
                { name: "tasaAplicable", label: "Tasa Aplicable", field: "tasaAplicable", align: "right", tipo: "porcentaje" },
                { name: "importeIsr", label: "Importe ISR", field: "importeIsr", align: "right", tipo: "moneda" },
                { name: "isrEmitido", label: "ISR Retenido", field: "isrEmitido", align: "right", tipo: "moneda" },
                { name: "isrPagar", label: "ISR a Pagar", field: "isrPagar", align: "right", tipo: "moneda" },
                { name: "impuestoregistrado", label: "Impuesto Registrado", field: "impuestoregistrado", align: "right", tipo: "moneda" },
            ...
            const filas = [];
            try {
                const tablas = await this.ppIsrGetTablas(año, "resico_fisica", "mensual");
                const ingresos = (await this.ppIsrGetIngresosCobrados(rfc, año, mesFValue)) || [];
                const registrados = (await this.ivaGetComparativa(rfc, año, "RegistradosPPIsr")) || [];
                const isrEmitido = (await this.isrGetRetenidoFavor(rfc, año, mesFValue)) || [];
                ...
                for (let i = 0; i < mesFValue; i++) {
                    ...
                    let importeIsr = 0;
                    if (importeIngreso !== 0) importeIsr = importeIngreso * ((tasaAplicable.tasa || 0) / 100);
        ...
        async ppIsrCalcularResicoMoral(rfc, año, mesFValue) {
            const columnas = [
                ...
                { name: "ingresosPorMes", label: "Ingresos por Mes", field: "ingresosPorMes", align: "right", tipo: "moneda" },
                { name: "ingresosAcumulados", label: "Ingresos Acumulados", field: "ingresosAcumulados", align: "right", tipo: "moneda" },
                { name: "deduccionesPorMes", label: "Deducciones por Mes", field: "deduccionesPorMes", align: "right", tipo: "moneda" },
                { name: "deduccionesAcumuladas", label: "Deducciones Acumuladas", field: "deduccionesAcumuladas", align: "right", tipo: "moneda" },
                { name: "utilidadFiscalPrevia", label: "Utilidad Fiscal del Mes Previa", field: "utilidadFiscalPrevia", align: "right", tipo: "moneda" },
                { name: "utilidadFiscalPreviaAcumulada", label: "Utilidad Fiscal del Mes Previa Acumulada", field: "utilidadFiscalPreviaAcumulada", align: "right", tipo: "moneda" },
                { name: "ptuPagada", label: "PTU Pagada", field: "ptuPagada", align: "right", tipo: "moneda" },
                { name: "utilidadFiscalAcumuladaPreviaAntesDePerdidasFiscales", label: "Utilidad Fiscal Acumulada Previa Antes de Pérdidas Fiscales", field: "utilidadFiscalAcumuladaPreviaAntesDePerdidasFiscales", align: "right", tipo: "moneda" },
                { name: "perdidasFiscalesPorAplicar", label: "Pérdidas Fiscales Por Aplicar", field: "perdidasFiscalesPorAplicar", align: "right", tipo: "moneda" },
                { name: "baseIsr", label: "Base de ISR", field: "baseIsr", align: "right", tipo: "moneda" },
                { name: "tasaIsr", label: "Tasa de ISR", field: "tasaIsr", align: "right", tipo: "texto" },
                { name: "isrDelPeriodo", label: "ISR del Periodo", field: "isrDelPeriodo", align: "right", tipo: "moneda" },
                { name: "isrPagosProvisionales", label: "ISR Pagos Provisionales", field: "isrPagosProvisionales", align: "right", tipo: "moneda" },
                { name: "isrAPagar", label: "ISR A Pagar", field: "isrAPagar", align: "right", tipo: "moneda" },
                { name: "impuestoregistrado", label: "Impuesto Registrado", field: "impuestoregistrado", align: "right", tipo: "moneda" },
                { name: "comparativa", label: "Comparativa", field: "comparativa", align: "right", tipo: "moneda" },
            ];
            const filas = [];
            try {
                const ingresos = (await this.ppIsrGetIngresosCobradosResicoM(rfc, año, mesFValue)) || [];
                const gastos = (await this.ppIsrGetGastosPagadosResicoM(rfc, año, mesFValue)) || [];
                ...
                for (let i = 0; i < mesFValue; i++) {
                    ...
                    const perdidasFiscalesPorAplicar = (perdida[i] && perdida[i].importe) || 0;
                    ...
                    const impuestoregistrado = (registrados[i] && registrados[i].importe) || 0;
        ...
        async ppIsrCalcularAcYSc(rfc, año, mesFValue) {
            const columnas = [
                { name: "mes", label: "Mes", field: "mes", align: "left", tipo: "texto" },
                { name: "ventas", label: "Ventas", field: "ventas", align: "right", tipo: "moneda" },
                { name: "productosFinancieros", label: "Productos Financieros", field: "productosFinancieros", align: "right", tipo: "moneda" },
                { name: "otrosProductos", label: "Otros Productos Financieros", field: "otrosProductos", align: "right", tipo: "moneda" },
                { name: "anticipoDeClientes", label: "Anticipo de Clientes", field: "anticipoDeClientes", align: "right", tipo: "moneda" },
                { name: "totalPeriodo", label: "Total del Periodo", field: "totalPeriodo", align: "right", tipo: "moneda" },
                { name: "ingresoAcumulable", label: "Ingreso Acumulable", field: "ingresoAcumulable", align: "right", tipo: "moneda" },
                { name: "coeficienteUtilidad", label: "Coeficiente de Utilidad", field: "coeficienteUtilidad", align: "right", tipo: "moneda" },
                { name: "utilidadFiscalEstimada", label: "Utilidad Fiscal Estimada", field: "utilidadFiscalEstimada", align: "right", tipo: "moneda" },
                { name: "ptu", label: "PTU a Aplicar en el Periodo", field: "ptu", align: "right", tipo: "moneda" },
                { name: "ptuAcumulada", label: "PTU Acumulada", field: "ptuAcumulada", align: "right", tipo: "moneda" },
                { name: "anticipoCuentaUtilidades", label: "Anticipo a Cuenta de Utilidades", field: "anticipoCuentaUtilidades", align: "right", tipo: "moneda" },
                { name: "anticipoCuentaUtilidadesAcumulado", label: "Anticipo a Cuenta de Utilidades Acumulado", field: "anticipoCuentaUtilidadesAcumulado", align: "right", tipo: "moneda" },
                { name: "resultadoFiscalPrevio", label: "Resultado Fiscal Previo", field: "resultadoFiscalPrevio", align: "right", tipo: "moneda" },
                { name: "perdidaDelEjercicioAnterior", label: "Pérdida del Ejercicio Anterior", field: "perdidaDelEjercicioAnterior", align: "right", tipo: "moneda" },
                { name: "baseParaIsr", label: "Base para ISR", field: "baseParaIsr", align: "right", tipo: "moneda" },
                { name: "tasaParaIsr", label: "Tasa para ISR", field: "tasaParaIsr", align: "right", tipo: "texto" },
                { name: "pagoProvisionalIsr", label: "Pago Provisional ISR", field: "pagoProvisionalIsr", align: "right", tipo: "moneda" },
                { name: "isrEnterado", label: "ISR Enterado", field: "isrEnterado", align: "right", tipo: "moneda" },
                { name: "isrAPagar", label: "ISR a Pagar", field: "isrAPagar", align: "right", tipo: "moneda" },
                { name: "impuestoregistrado", label: "Impuesto Registrado", field: "impuestoregistrado", align: "right", tipo: "moneda" },
                { name: "comparativa", label: "Comparativa", field: "comparativa", align: "right", tipo: "moneda" },
            ];
        ...
        async ppIsrGetReporte(rfc, año, mesFValue) {
            ...
            try {
                ...
                const regimen = (regimenes || []).find((o) => String(o.año) === String(año));
                ...
                const tipoPersona = rfc.length === 12 ? "MORAL" : rfc.length === 13 ? "FISICA" : "";
                ...
                if (claveRegimen === "601") {
                    ...
                    resultado = await this.ppIsrCalcularFisicaActividadEmpresarial(rfc, año, mesFValue);
                } else {
                    return {
                        ...vacio,
        ...
        async cfdiGetReporte(rfc, fI, fF) {
            try {
                ...
                usosUnicos.forEach((uso) => {
                    ...
                    const nominaTotal = objNomina ? (objNomina.subTotal || 0) - (objNomina.descuento || 0) : 0;
        ...
        async comparativaAnualObtener(rfc, año) {
            const filasVacias = [
                { concepto: "Coeficiente de Utilidad del Ejercicio", tipo: "porcentaje" },
            ...
            ].map((f) => ({ ...f, determinado: null, declarado: null, diferencia: null }));
            ...
            try {
                ...
                const ingresosDeterminado = (usoCfdiAnual || []).reduce((a, f) => a + (f.emitidos || 0), 0);
                const deduccionesDeterminado = (usoCfdiAnual || []).reduce(
                    (a, f) => a + (f.recibidos || 0) + (f.nomina || 0),
                    0
                );
                const resultadoDeterminado = ingresosDeterminado - deduccionesDeterminado;
                const utilidadDeterminado = resultadoDeterminado > 0 ? resultadoDeterminado : 0;
                const perdidaDeterminado = resultadoDeterminado < 0 ? Math.abs(resultadoDeterminado) : 0;
                const coeficienteDeterminado =
                    ingresosDeterminado !== 0 ? utilidadDeterminado / ingresosDeterminado : 0;
                ...
                try {
                    ...
                    console.log("Error leyendo la Declaración Anual declarada:", errorDeclarado);
                    mensaje = "No se pudo leer el archivo de la Declaración Anual. Se muestra únicamente lo Determinado.";
                }

                const armarFila = (concepto, tipo, valorDeterminado, campoDeclarado) => {
                    ...
                    return {
                        ...
                        diferencia: valorDeclarado !== null && valorDeclarado !== undefined
                ...
                const filas = [
                    armarFila("Coeficiente de Utilidad del Ejercicio", "porcentaje", coeficienteDeterminado, "coeficienteUtilidad"),
                    armarFila("Total de Ingresos Acumulables", "moneda", ingresosDeterminado, "ingresosAcumulables"),
                    armarFila("Total de Deducciones Autorizadas", "moneda", deduccionesDeterminado, "deduccionesAutorizadas"),
                    armarFila("Pérdida Fiscal", "moneda", perdidaDeterminado, "perdidaFiscal"),
                    armarFila("Utilidad Fiscal", "moneda", utilidadDeterminado, "utilidadFiscal"),
                ];

                return { filas, mensaje };
            } catch (error) {
                console.log("Error en comparativaAnualObtener:", error);
                return { filas: filasVacias, mensaje: "Ocurrió un error calculando la Comparativa Anual." };
            }
        },
        ...
        async generarReporte() {
            ...
            const fI = moment(`${año}-${String(mesI).padStart(2, "0")}-01`).startOf("month").format("YYYY-MM-DD");
            const fF = moment(`${año}-${String(mesF).padStart(2, "0")}-01`).endOf("month").format("YYYY-MM-DD");
            ...
            try {
                ...
                tareas.push(
                    this.mostrarSecciones.emitidos
                        ? this.GetReporteRFc(rfc, "comprobantes_emitidos", año, mesI, mesF, 1)
                        : Promise.resolve([])
                );
                tareas.push(
                    this.mostrarSecciones.recibidos
                        ? this.GetReporteRFc(rfc, "comprobantes_recibidos", año, mesI, mesF, 1)
                        : Promise.resolve([])
                );
                ...
                // CxC / CxP
                tareas.push(this.mostrarSecciones.cxc ? this.GetCxC(rfc, fI, fF) : Promise.resolve([]));
                tareas.push(this.mostrarSecciones.cxp ? this.GetCxP(rfc, fI, fF) : Promise.resolve([]));
                ...
                // ---- Comprobantes ----
                this.tablaComprobantesEmitidos = Array.isArray(emitidos) ? emitidos : [];
                this.tablaComprobantesRecibidos = Array.isArray(recibidos) ? recibidos : [];
                ...
                if (Array.isArray(importesN)) {
                    if (importesN.length && importesN[0] && !Array.isArray(importesN[0]) && "mes" in importesN[0]) {
                ...
                this.tablaComparativaFlujo = this.compararPUEPorMes(flujoEmitido || [], flujoRecibido || []);

                // ---- Pagos de IVA ----
                this.tablaPagosIva = Array.isArray(pagosIva) ? pagosIva : [];

                // ---- Retenciones de ISR ----
                if (pagosIsr && typeof pagosIsr === "object" && !Array.isArray(pagosIsr)) {
                    this.tablaPagosIsr = {
                        sueldos: Array.isArray(pagosIsr.sueldos) ? pagosIsr.sueldos : [],
                        asimilados: Array.isArray(pagosIsr.asimilados) ? pagosIsr.asimilados : [],
                        otros: Array.isArray(pagosIsr.otros) ? pagosIsr.otros : [],
                        arrendamientos: Array.isArray(pagosIsr.arrendamientos) ? pagosIsr.arrendamientos : [],
                        honorarios: Array.isArray(pagosIsr.honorarios) ? pagosIsr.honorarios : [],
                        demasIngresos: Array.isArray(pagosIsr.demasIngresos) ? pagosIsr.demasIngresos : [],
                        isrRetenidoFavor: Array.isArray(pagosIsr.isrRetenidoFavor) ? pagosIsr.isrRetenidoFavor : [],
                    };
                } else {
                    this.tablaPagosIsr = {
                        sueldos: [], asimilados: [], otros: [],
                ...
                // ---- Pagos Provisionales de ISR ----
                if (pagosProvisionales && typeof pagosProvisionales === "object" && !Array.isArray(pagosProvisionales)) {
                    this.tablaPagosProvisionales = {
                        columnas: Array.isArray(pagosProvisionales.columnas) ? pagosProvisionales.columnas : [],
                        filas: Array.isArray(pagosProvisionales.filas) ? pagosProvisionales.filas : [],
                        mensaje: pagosProvisionales.mensaje || "",
                        regimenLabel: pagosProvisionales.regimenLabel || "",
                    };
                } else {
                    this.tablaPagosProvisionales = { columnas: [], filas: [], mensaje: "", regimenLabel: "" };
                }
                ...
                if (comparativaAnual && typeof comparativaAnual === "object") {
                    this.tablaComparativaAnual = Array.isArray(comparativaAnual.filas) ? comparativaAnual.filas : [];
                ...
                this.$q.notify({ type: "negative", message: "Ocurrió un error al generar el reporte." });
            } finally {
                this.loading = false;
                this.$q.loading.hide();
            }
        ...
        obtenerFechaMasGrande(detalles) {
            ...
            return detalles.reduce((max, d) => {
                return !max || moment(d.fechaPago).isAfter(moment(max)) ? d.fechaPago : max;
            }, null);
        },
        ...
        generarPdf() {
            try {
                ...
                this.$q.notify({ type: "negative", message: "Ocurrió un error al generar el PDF." });
            }
...
.rg-chip--active.rg-chip--emitidos { border-color: var(--rg-emitidos); color: var(--rg-emitidos) !important; background: var(--rg-emitidos-soft) !important; }
.rg-chip--active.rg-chip--recibidos { border-color: var(--rg-recibidos); color: var(--rg-recibidos) !important; background: var(--rg-recibidos-soft) !important; }
.rg-chip--active.rg-chip--nomina { border-color: var(--rg-nomina); color: var(--rg-nomina) !important; background: var(--rg-nomina-soft) !important; }
.rg-chip--active.rg-chip--cxc { border-color: var(--rg-cxc); color: var(--rg-cxc) !important; background: var(--rg-cxc-soft) !important; }
.rg-chip--active.rg-chip--cxp { border-color: var(--rg-cxp); color: var(--rg-cxp) !important; background: var(--rg-cxp-soft) !important; }
.rg-chip--active.rg-chip--flujo { border-color: var(--rg-flujo); color: var(--rg-flujo) !important; background: var(--rg-flujo-soft) !important; }
.rg-chip--active.rg-chip--pagosIva { border-color: var(--rg-pagosiva); color: var(--rg-pagosiva) !important; background: var(--rg-pagosiva-soft) !important; }
.rg-chip--active.rg-chip--pagosIsr { border-color: var(--rg-pagosisr); color: var(--rg-pagosisr) !important; background: var(--rg-pagosisr-soft) !important; }
...
.rg-kpi--emitidos::before { background: var(--rg-emitidos); }
.rg-kpi--emitidos .rg-kpi__icon { color: var(--rg-emitidos); }
.rg-kpi--emitidos .rg-kpi__value { color: var(--rg-emitidos); }

.rg-kpi--recibidos::before { background: var(--rg-recibidos); }
.rg-kpi--recibidos .rg-kpi__icon { color: var(--rg-recibidos); }
.rg-kpi--recibidos .rg-kpi__value { color: var(--rg-recibidos); }

.rg-kpi--nomina::before { background: var(--rg-nomina); }
.rg-kpi--nomina .rg-kpi__icon { color: var(--rg-nomina); }
.rg-kpi--nomina .rg-kpi__value { color: var(--rg-nomina); }

.rg-kpi--flujo::before { background: var(--rg-flujo); }
.rg-kpi--flujo .rg-kpi__icon { color: var(--rg-flujo); }
.rg-kpi--flujo .rg-kpi__value { color: var(--rg-flujo); }

/* ===================== SECTION HEADERS ===================== */
.rg-section {
    border-top: 3px solid transparent;
}
.rg-section--emitidos { border-top-color: var(--rg-emitidos); }
.rg-section--recibidos { border-top-color: var(--rg-recibidos); }
.rg-section--nomina { border-top-color: var(--rg-nomina); }
.rg-section--cxc { border-top-color: var(--rg-cxc); }
.rg-section--cxp { border-top-color: var(--rg-cxp); }
.rg-section--flujo { border-top-color: var(--rg-flujo); }
.rg-section--pagosiva { border-top-color: var(--rg-pagosiva); }
.rg-section--pagosisr { border-top-color: var(--rg-pagosisr); }
...
.rg-section--emitidos .rg-section__icon { color: var(--rg-emitidos); background: var(--rg-emitidos-soft); }
.rg-section--recibidos .rg-section__icon { color: var(--rg-recibidos); background: var(--rg-recibidos-soft); }
.rg-section--nomina .rg-section__icon { color: var(--rg-nomina); background: var(--rg-nomina-soft); }
.rg-section--cxc .rg-section__icon { color: var(--rg-cxc); background: var(--rg-cxc-soft); }
.rg-section--cxp .rg-section__icon { color: var(--rg-cxp); background: var(--rg-cxp-soft); }
.rg-section--flujo .rg-section__icon { color: var(--rg-flujo); background: var(--rg-flujo-soft); }
.rg-section--pagosiva .rg-section__icon { color: var(--rg-pagosiva); background: var(--rg-pagosiva-soft); }
.rg-section--pagosisr .rg-section__icon { color: var(--rg-pagosisr); background: var(--rg-pagosisr-soft); }
...
.rg-positive { color: var(--rg-emitidos); }
.rg-negative { color: var(--rg-recibidos); }
