...
export default {
    ...
    methods: {
        async GetReporte() {
            ...
            try {
                let response = await axios.get(this.rutaAxios + 'Ingresos/GetCanceladoRecibidosAsync/erp_' + this.token.rfc + '/' + fI + '/' + fF);
        ...
        //     XLSX.writeFile(workbook, 'REPORTE DE COMPROBANTES RECIBIDOS CANCELADOS DEL ' + fI + ' AL ' + fF + '.xlsx');
        // },
        ...
        ExportExcel() {
            ...
            let reporte = 'REPORTE DE COMPROBANTES RECIBIDOS CANCELADOS'
            ...
            xlsx.writeFile(
                workbook,
                rfc + ' - ' + empresa +  ' - REPORTE DE COMPROBANTES RECIBIDOS CANCELADOS DEL ' + periodo.toUpperCase() + '.xlsx'
            );
            },
        ...
        async VerComprobanteI(item) {
            try {
                console.log(item)
                let response = await axios.get(this.rutaAxios + 'Comprobante/GetComprobanteRecibidoAsync/erp_' + this.token.rfc + '/' + item.folioFiscal);
                let x = response.data;
                console.log(x);
                let color = "#" + '00A35C';
        ...
        async VerComprobanteP(item) {
            try {
                console.log(item)
                let response = await axios.get(this.rutaAxios + 'Comprobante/GetComprobantePagoRecibidoAsync/erp_' + this.token.rfc + '/' + item.folioFiscal);
                let x = response.data;
                console.log(x);
                let color = "#" + '00A35C';
