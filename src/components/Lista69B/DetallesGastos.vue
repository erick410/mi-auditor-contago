        ...
        <q-card flat class="my-card">
            <q-card-section>
                ...
                <div class="row no-wrap items-center q-mt-md q-pa-sm">
                    <q-btn push color="red-14" @click="CloseDialogG" icon="mdi-close" rounded flat size="18px"
                        padding="xs">
...
export default {
    ...
    computed: {
        ...
        dataComprobantes() {
            return this.$store.state.comprobantes69BG;
    ...
    methods: {
        ...
        ExportExcel() {
            let reporte = 'REPORTE DETALLADO DE GASTOS'
            ...
            xlsx.writeFile(
                workbook,
                rfc + ' - ' + empresa +  ' - REPORTE DETALLADO DE GASTOS DEL ' + periodo.toUpperCase() + '.xlsx'
            );
            },
        ...
        CloseDialogG() {
            this.$emit('CloseDialogDetallesG')
        },
    },
}
