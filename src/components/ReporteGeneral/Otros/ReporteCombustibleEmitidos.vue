...
<script>
    export default {
        data() {
            return {
                columns: [
                    ...
                    { name: 'descripción', label: 'Descripción', align: 'left', field: 'descripción', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-otros text-white', },
                ...
                columnsTotales: [
                    ...
                    { name: 'descripción', label: 'Descripción', align: 'left', field: 'descripción', sortable: true, classes: 'total-row-o ellipsis', headerClasses: 'bgc-otros text-white', },
        ...
        computed: {
            ...
            items() {
                return this.$store.state.dataViewReporte[45];
            },
        },
        methods: {
