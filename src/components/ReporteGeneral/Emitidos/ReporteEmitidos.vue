<template>
  <div style="width: 100%;">
    ...
    <div class="titulo-reporte-emitidos">
      EMITIDOS TIPO INGRESO
    </div>
    <div class="q-mb-md">
      <div v-if="items && items.contenido">
        <q-table :data="items.contenido" :columns="columnsIngreso" row-key="mes" flat bordered class="shadow-0 border-0"
          dense>
          <template v-slot:body="props">
            <q-tr :props="props" class="hover-foliofiscal-e">
              <q-td key="mes" :props="props" @click="GetDetalleI(props.row)">{{ props.row.mes }}</q-td>
              <q-td key="contadorI" :props="props" @click="GetDetalleI(props.row)">{{ props.row.contadorI }}</q-td>
              <q-td key="subTotalI" :props="props" @click="GetDetalleI(props.row)">{{
                formatCurrency(props.row.subTotalI)
                }}</q-td>
              ...
              <q-td key="totalI" :props="props" @click="GetDetalleI(props.row)">{{ formatCurrency(props.row.totalI)
                }}</q-td>
            </q-tr>
          </template>
        </q-table>
    ...
    <div class="titulo-reporte-emitidos">
      EMITIDOS TIPO EGRESO
    </div>
    <div class="q-mb-md">
      <div v-if="items && items.contenido">

        <q-table :data="items.contenido" :columns="columnsEgreso" row-key="mes" flat bordered class="shadow-0 border-0"
          dense>
          <template v-slot:body="props">
            <q-tr :props="props" class="hover-foliofiscal-e">
              <q-td key="mes" :props="props" @click="GetDetalleE(props.row)">{{ props.row.mes }}</q-td>
              <q-td key="contadorE" :props="props" @click="GetDetalleE(props.row)">{{ props.row.contadorE }}</q-td>
              <q-td key="subTotalE" :props="props" @click="GetDetalleE(props.row)">{{
                formatCurrency(props.row.subTotalE)
                }}</q-td>
              ...
              <q-td key="totalE" :props="props" @click="GetDetalleE(props.row)">{{ formatCurrency(props.row.totalE)
                }}</q-td>
            </q-tr>
          </template>
        </q-table>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        columnsIngreso: [
          ...
          { name: 'contadorI', label: '# Comprobantes', align: 'center', field: 'contadorI', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white', },
          { name: 'subTotalI', label: 'SubTotal', align: 'right', field: 'subTotalI', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'trasladosI', label: 'Traslados', align: 'right', field: 'trasladosI', sortable: true, classes: 'bg-grey-2 ellipsis ', headerClasses: 'bgc-emitidos text-white' },
          { name: 'retencionesI', label: 'Retenciones', align: 'right', field: 'retencionesI', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'totalI', label: 'Total', align: 'right', field: 'totalI', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white' },
        ],

        columnsEgreso: [
          { name: 'mes', label: 'Mes', align: 'center', field: 'mes', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'contadorE', label: '# Comprobantes', align: 'center', field: 'contadorE', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white', },
          { name: 'subTotalE', label: 'SubTotal', align: 'right', field: 'subTotalE', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'trasladosE', label: 'Traslados', align: 'right', field: 'trasladosE', sortable: true, classes: 'bg-grey-2 ellipsis ', headerClasses: 'bgc-emitidos text-white' },
          { name: 'retencionesE', label: 'Retenciones', align: 'right', field: 'retencionesE', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'totalE', label: 'Total', align: 'right', field: 'totalE', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-emitidos text-white' },
        ],
        ...
        columnsTotalesI: [
          ...
          { name: 'contadorI', label: '# Comprobantes', align: 'center', field: 'contadorI', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white', },
          { name: 'subTotalI', label: 'SubTotal', align: 'right', field: 'subTotalI', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'trasladosI', label: 'Traslados', align: 'right', field: 'trasladosI', sortable: true, classes: 'total-row-e ellipsis ', headerClasses: 'bgc-emitidos text-white' },
          { name: 'retencionesI', label: 'Retenciones', align: 'right', field: 'retencionesI', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'totalI', label: 'Total', align: 'right', field: 'totalI', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white' },
        ],

        columnsTotalesE: [
          { name: 'mes', label: 'Mes', align: 'center', field: 'mes', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'contadorE', label: '# Comprobantes', align: 'center', field: 'contadorE', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white', },
          { name: 'subTotalE', label: 'SubTotal', align: 'right', field: 'subTotalE', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'trasladosE', label: 'Traslados', align: 'right', field: 'trasladosE', sortable: true, classes: 'total-row-e ellipsis ', headerClasses: 'bgc-emitidos text-white' },
          { name: 'retencionesE', label: 'Retenciones', align: 'right', field: 'retencionesE', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white' },
          { name: 'totalE', label: 'Total', align: 'right', field: 'totalE', sortable: true, classes: 'total-row-e ellipsis', headerClasses: 'bgc-emitidos text-white' },
        ],
    ...
    computed: {
      ...
      items() {
        return this.$store.state.dataViewReporte[2];
      },
      fechas() {
    ...
    methods: {
      ...
      async GetDetalleI(item) {
        ...
        try {
          ...
          this.$store.state.detallesFacturacionStore.cabecera = 'EMITIDOS TIPO INGRESO ' + item.mes.toUpperCase() + ' DEL ' + this.fechas.anio;
      ...
      async GetDetalleE(item) {
        ...
        try {
          ...
          this.$store.state.detallesFacturacionStore.cabecera = 'EMITIDOS TIPO EGRESO ' + item.mes.toUpperCase() + ' DEL ' + this.fechas.anio;
