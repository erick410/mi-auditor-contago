            ...
            <q-table :data="registros" :columns="columns" row-key="folio" flat bordered class="shadow-0 border-0" dense
                ...
                <template v-slot:body="props">
                    <q-tr :props="props">
                        ...
                        <q-td key="totalImpuestosTrasladados" :props="props">{{
                            formatCurrency(props.row.totalImpuestosTrasladados) }}</q-td>
                        <q-td key="totalImpuestosRetenidos" :props="props">{{
                            formatCurrency(props.row.totalImpuestosRetenidos) }}</q-td>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                columns: [
                    ...
                    { name: 'claveProdServ', label: 'Clave Producto o Servicio', align: 'left', field: 'claveProdServ', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'concepto', label: 'Concepto', align: 'left', field: 'concepto', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'tipoComprobante', label: 'Tipo de Comprobante', align: 'center', field: 'tipoComprobante', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    ...
                    { name: 'totalImpuestosTrasladados', label: 'Total Impuestos Trasladados', align: 'right', field: 'totalImpuestosTrasladados', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'totalImpuestosRetenidos', label: 'Total Impuestos Retenidos', align: 'right', field: 'totalImpuestosRetenidos', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'total', label: 'Total', align: 'right', field: 'total', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-riesgo text-white' },
                ],
                columnsTotales: [
                    ...
                    { name: 'nombre', label: 'Nombre', align: 'left', field: 'importeRecibido', sortable: true, classes: 'total-row-rf ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'claveProdServ', label: 'Clave Producto o Servicio', align: 'left', field: 'claveProdServ', sortable: true, classes: 'total-row-rf ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'concepto', label: 'Concepto', align: 'left', field: 'concepto', sortable: true, classes: 'total-row-rf ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'tipoComprobante', label: 'Tipo de Comprobante', align: 'center', field: 'tipoComprobante', sortable: true, classes: 'total-row-rf ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    ...
                    { name: 'totalImpuestosTrasladados', label: 'Total Impuestos Trasladados', align: 'right', field: 'totalImpuestosTrasladados', sortable: true, classes: 'total-row-rf ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'totalImpuestosRetenidos', label: 'Total Impuestos Retenidos', align: 'right', field: 'totalImpuestosRetenidos', sortable: true, classes: 'total-row-rf ellipsis', headerClasses: 'bgc-riesgo text-white' },
                    { name: 'total', label: 'Total', align: 'right', field: 'total', sortable: true, classes: 'total-row-rf ellipsis', headerClasses: 'bgc-riesgo text-white' },
                ],
                dialogPdf: false,
        ...
        computed: {
            ...
            items() {
                return this.$store.state.dataViewReporte[23];
            },
        },
        methods: {
            ...
            getTotales(registros) {
                return {
                    ...
                    totalImpuestosTrasladados: registros.reduce((sum, r) => sum + (r.totalImpuestosTrasladados || 0), 0),
                    totalImpuestosRetenidos: registros.reduce((sum, r) => sum + (r.totalImpuestosRetenidos || 0), 0),
            ...
            VerFolioFiscal(item) {
                try {
                    ...
                    if (item.tipoComprobante === "T") {
                        this.$store.state.vistaPreviaGenStore.tipoComprobanteInterno = "TRASLADO"
                    }
