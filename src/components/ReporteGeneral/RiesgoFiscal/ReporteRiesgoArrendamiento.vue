<template>
    <div style="width: 100%;">
        ...
        <div v-for="(registros, mes) in items.contenido" :key="mes" class="q-mb-md">
            <q-table :data="registros" :columns="columns" row-key="folioFiscal" flat bordered class="shadow-0 border-0"
                dense :title="mes">
                <template v-slot:body="props">
                    <q-tr :props="props">
                        ...
                        <q-td key="totalImpuestosTrasladados" :props="props">{{
                            formatCurrency(props.row.totalImpuestosTrasladados)
                            }}</q-td>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            items() {
                return this.$store.state.dataViewReporte[25];
            },
        },
        methods: {
