...
<script>
    ...
    export default {
        ...
        data() {
            return {
                columns: [
                    ...
                    { name: 'rfc', label: 'RFC', align: 'left', field: 'rfc', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-riesgo text-white' },
        ...
        computed: {
            ...
            items() {
                return this.$store.state.dataViewReporte[21];
            },
        },
        methods: {
