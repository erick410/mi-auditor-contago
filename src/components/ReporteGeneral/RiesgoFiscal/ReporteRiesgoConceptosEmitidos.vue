...
<script>
    ...
    export default {
        ...
        data() {
            return {
                columns: [
                    ...
                    { name: 'metodoPago', label: 'Metodo de Pago', align: 'left', field: 'metodoPago', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-riesgo text-white' },
        ...
        computed: {
            ...
            items() {
                return this.$store.state.dataViewReporte[26];
            },
        },
        methods: {
