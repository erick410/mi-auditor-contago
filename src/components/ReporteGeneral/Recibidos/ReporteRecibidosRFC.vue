<template>
    <div style="width: 100%;">
        ...
        <div v-if="items && items.contenido" class="q-mb-md">
            <q-table :data="items.contenido" :columns="columnsRecibidos" row-key="mes" flat bordered
                ...
                <template v-slot:body="props">
                    <q-tr :props="props" class="hover-foliofiscal-r">
                        ...
                        <q-td key="importeI" :props="props" @click="GetReporte(props.row)">{{
                            formatCurrency(props.row.importeI)
                            }}</q-td>
                        ...
                        <q-td key="importeE" :props="props" @click="GetReporte(props.row)">{{
                            formatCurrency(props.row.importeE)
                            }}</q-td>
                    </q-tr>
                </template>
            </q-table>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                columnsRecibidos: [
                    { name: 'rfc', label: 'RFC', align: 'center', field: 'rfc', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-recibidos text-white' },
                    { name: 'nombre', label: 'Nombre', align: 'left', field: 'nombre', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-recibidos text-white' },
                    { name: 'ingresos', label: '# Ingresos', align: 'center', field: 'ingresos', sortable: true, classes: 'bg-grey-2 ellipsis ', headerClasses: 'bgc-recibidos text-white' },
                    { name: 'importeI', label: 'Importe', align: 'right', field: 'importeI', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-recibidos text-white' },
                    { name: 'egresos', label: '# Egresos', align: 'center', field: 'egresos', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-recibidos text-white', },
                    { name: 'importeE', label: 'Importe', align: 'right', field: 'importeE', sortable: true, classes: 'bg-grey-2 ellipsis', headerClasses: 'bgc-recibidos text-white', },
                ],
                columnsTotales: [
                    { name: 'rfc', label: 'RFC', align: 'center', field: 'rfc', sortable: true, classes: 'total-row-r ellipsis', headerClasses: 'bgc-emitidos text-white' },
                    { name: 'nombre', label: 'Nombre', align: 'left', field: 'nombre', sortable: true, classes: 'total-row-r ellipsis', headerClasses: 'bgc-emitidos text-white' },
                    { name: 'ingresos', label: '# Ingresos', align: 'center', field: 'ingresos', sortable: true, classes: 'total-row-r ellipsis ', headerClasses: 'bgc-emitidos text-white' },
                    { name: 'importeI', label: 'Importe', align: 'right', field: 'importeI', sortable: true, classes: 'total-row-r ellipsis', headerClasses: 'bgc-emitidos text-white' },
                    { name: 'egresos', label: '# Egresos', align: 'center', field: 'egresos', sortable: true, classes: 'total-row-r ellipsis', headerClasses: 'bgc-emitidos text-white', },
                    { name: 'importeE', label: 'Importe', align: 'right', field: 'importeE', sortable: true, classes: 'total-row-r ellipsis', headerClasses: 'bgc-emitidos text-white', },
                ],
        ...
        computed: {
            ...
            items() {
                return this.$store.state.dataViewReporte[5];
            },
            fechas() {
        ...
        methods: {
            ...
            async GetReporte(item) {
                ...
                let f = moment({ year: this.fechas.anio, month: this.fechas.mesFinal - 1, day: 1 }).format('MM');;
                ...
                try {
                    let response = await axios.get(this.rutaAxios + 'Gastos/GetReporteAcumuladoPorRfcAsync/erp_' + this.token.rfc + '/' + fechaI + '/' + fechaF);
                    let x = response.data;
