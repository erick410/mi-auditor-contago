...
export default {
    ...
    methods: {
        ...
        async GetReporte() {
            ...
            try {
                let response = await axios.get(this.rutaAxios + 'Gastos/GetReporteConceptosAcumuladoAsync/erp_' + this.token.rfc + '/' + fI + '/' + fF + '/' + this.selectAgrupador);
                let x = response.data;
        ...
        //     XLSX.writeFile(workbook, 'CONCEPTOS COMPRADOS DEL ' + fI + ' AL ' + fF + '.xlsx');
        // },
