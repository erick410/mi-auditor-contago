    ...
    export default {
        ...
        methods: {
            async GetReporte() {
                ...
                try {
                    let response = await axios.get(this.rutaAxios + 'Ingresos/GetReporteAnticiposClienteAsync/erp_' + this.token.rfc + '/' + fI + '/' + fF);
                    let x = response.data;
            ...
            //     XLSX.writeFile(workbook, 'ANTICIPOS POR CLIENTE DEL ' + fI + ' AL ' + fF + '.xlsx');
            // },

            ExportExcel() {
            let reporte = 'REPORTE DE ANTICIPOS POR CLIENTES'
            ...
            xlsx.writeFile(
                workbook,
                rfc.toUpperCase() + ' - ' + empresa.toUpperCase() +  ' - REPORTE DE ANTICIPOS POR CLIENTES DEL' + periodo.toUpperCase() + '.xlsx'
            );
            },
