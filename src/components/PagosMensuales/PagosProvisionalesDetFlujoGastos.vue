<template>
    <div class="q-pa-md">
        ...
        <q-table :filter="filter" :data="items.detalles" :columns="columns" row-key="folioFiscal" :rows-per-page-options="[10]"
            class="my-sticky-column-table"  selection="multiple" :selected.sync="itemsSeleccion">
            ...
            <template v-slot:bottom-row>
                <q-tr>
                    <q-td colspan="100%" class="text-center">
                        ...
                        <q-chip color="primary" text-color="white">
                            {{ 'Subtotal pagado: ' + formatCurrency(sumaPagado) }}
                        </q-chip>
                    </q-td>
                </q-tr>
            </template>
...
export default {
    ...
    data() {
        return {
            columns: [
                ...
                { name: 'subTotalPagado', align: 'right', label: 'subTotal Pagado', field: 'subTotalPagado', sortable: true },
    ...
    computed: {
        ...
        sumaSeleccionado() {
            return this.itemsSeleccion.reduce((acumulador, objeto) => acumulador + objeto.subTotalPagado, 0);
        },
        sumaPagado() {
            return this.items.detalles.reduce((acumulador, objeto) => acumulador + objeto.subTotalPagado, 0);
        },
    },
    created() {
