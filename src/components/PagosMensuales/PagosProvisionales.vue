                ...
                <q-tr :props="props" :class="'clase-total-' + props.row.mes">
                    ...
                    <template v-if="civiles === 'NO'">
                        ...
                        <template v-if="regimenSeleccionadoClave === '601'">
                            ...
                            <q-td key="utilidadFiscal" :props="props">{{
                                FormatCurrency(props.row.utilidadFiscal)
                                }}</q-td>
                            <q-td key="basePagoProvisional" :props="props">{{
                                FormatCurrency(props.row.basePagoProvisional)
                                }}</q-td>
                            <q-td key="pagoProvisional" :props="props">{{
                                FormatCurrency(props.row.pagoProvisional)
                                }}</q-td>
                            <q-td key="impuestoCargo" :props="props">{{
                                FormatCurrency(props.row.impuestoCargo)
                                }}</q-td>
                        </template>
                        ...
                        <template v-if="regimenSeleccionadoClave === '612'">
                            ...
                            <q-td key="gastosPorMes" :props="props">{{
                            ...
                            <q-td key="gastosAcumulados" :props="props">{{
                                FormatCurrency(props.row.gastosAcumulados)
                                }}</q-td>
                            <q-td key="baseCalculo" :props="props">{{
                                FormatCurrency(props.row.baseCalculo)
                                }}</q-td>
                            <q-td key="limiteInferior" :props="props">{{
                                FormatCurrency(props.row.limiteInferior)
                                }}</q-td>
                            <q-td key="baseImpuesto" :props="props">{{
                                FormatCurrency(props.row.baseImpuesto)
                                }}</q-td>
                            <q-td key="porcentaje" :props="props">{{
                                PorcentajeCurrency(props.row.porcentaje)
                                }}</q-td>
                            <q-td key="impuestoMarginal" :props="props">{{
                                FormatCurrency(props.row.impuestoMarginal)
                                }}</q-td>
                            <q-td key="cuotaFija" :props="props">{{
                                FormatCurrency(props.row.cuotaFija)
                                }}</q-td>
                            <q-td key="importeIsr" :props="props">{{
                                FormatCurrency(props.row.importeIsr)
                                }}</q-td>
                            <q-td key="pagosAnteriores" :props="props">{{
                                FormatCurrency(props.row.pagosAnteriores)
                                }}</q-td>
                            <q-td key="isrCargo" :props="props">{{
                                FormatCurrency(props.row.isrCargo)
                                }}</q-td>
                            <q-td key="isrEmitido" :props="props">{{
                                FormatCurrency(props.row.isrEmitido)
                                }}</q-td>
                                <q-td auto-width  key="isrDetalles" :props="props"> 
                                    <q-btn size="md" color="primary" rounded flat dense
                                    @click="abrirDetallesISREmitido(props.row.isrDetalles)"
                                    icon="mdi-format-list-bulleted" v-if="props.row.detalles.length != 0">
                                    <q-tooltip transition-show="flip-right" transition-hide="flip-left"
                                        content-style="font-size: 14px" :offset="[10, 10]">Detalles</q-tooltip>
                                </q-btn>
                                </q-td>
                                <q-td key="isrPagar" :props="props">{{
                                FormatCurrency(props.row.isrPagar)
                                }}</q-td>
                        </template>
                        <!-- RESICO FISICA -->
                        <template v-if="
                        ...
                        ">
                            ...
                            <q-td key="tasaAplicable" :props="props">{{
                                PorcentajeCurrency(props.row.tasaAplicable)
                                }}</q-td>
                            <q-td key="importeIsr" :props="props">{{
                                FormatCurrency(props.row.importeIsr)
                                }}</q-td>
                        ...
                        ">
                            ...
                            <q-td key="deduccionesPorMes" :props="props">{{
                            ...
                            <q-td key="baseIsr" :props="props">{{
                                FormatCurrency(props.row.baseIsr)
                                }}</q-td>
                            <q-td key="tasaIsr" :props="props">{{ props.row.tasaIsr }}</q-td>
                            <q-td key="isrDelPeriodo" :props="props">{{
                                FormatCurrency(props.row.isrDelPeriodo)
                                }}</q-td>
                            <q-td key="isrPagosProvisionales" :props="props">{{
                                FormatCurrency(props.row.isrPagosProvisionales)
                                }}</q-td>
                            <q-td key="isrAPagar" :props="props">{{
                                FormatCurrency(props.row.isrAPagar)
                                }}</q-td>
                        </template>
                    </template>
                    ...
                    <template v-if="civiles === 'SI'">
                        <q-td key="ventas" :props="props">{{
                            FormatCurrency(props.row.ventas)
                            }}</q-td>
                        <q-td key="productosFinancieros" :props="props">{{
                            FormatCurrency(props.row.productosFinancieros)
                            }}</q-td>
                        <q-td key="otrosProductos" :props="props">{{
                            FormatCurrency(props.row.otrosProductos)
                            }}</q-td>
                        <q-td key="anticipoDeClientes" :props="props">{{
                            FormatCurrency(props.row.anticipoDeClientes)
                            }}</q-td>
                        <q-td key="totalPeriodo" :props="props">{{
                            FormatCurrency(props.row.totalPeriodo)
                            }}</q-td>
                        <q-td key="ingresoAcumulable" :props="props">{{
                            FormatCurrency(props.row.ingresoAcumulable)
                            }}</q-td>
                        <q-td key="coeficienteUtilidad" :props="props">{{
                            FormatCurrency(props.row.coeficienteUtilidad)
                            }}</q-td>
                        <q-td key="utilidadFiscalEstimada" :props="props">{{
                            FormatCurrency(props.row.utilidadFiscalEstimada)
                            }}</q-td>
                        <q-td key="ptu" :props="props">{{
                            FormatCurrency(props.row.ptu)
                            }}</q-td>
                        <q-td key="ptuAcumulada" :props="props">{{
                            FormatCurrency(props.row.ptuAcumulada)
                            }}</q-td>
                        <q-td key="anticipoCuentaUtilidades" :props="props">{{
                            FormatCurrency(props.row.anticipoCuentaUtilidades)
                            }}</q-td>
                        <q-td key="anticipoCuentaUtilidadesAcumulado" :props="props">{{
                            FormatCurrency(props.row.anticipoCuentaUtilidadesAcumulado)
                            }}</q-td>
                        <q-td key="resultadoFiscalPrevio" :props="props">{{
                            FormatCurrency(props.row.resultadoFiscalPrevio)
                            }}</q-td>
                        <q-td key="perdidaDelEjercicioAnterior" :props="props">{{
                            FormatCurrency(props.row.perdidaDelEjercicioAnterior)
                            }}</q-td>
                        <q-td key="baseParaIsr" :props="props">{{
                            FormatCurrency(props.row.baseParaIsr)
                            }}</q-td>
                        <q-td key="tasaParaIsr" :props="props">{{
                            FormatCurrency(props.row.tasaParaIsr)
                            }}</q-td>
                        <q-td key="pagoProvisionalIsr" :props="props">{{
                            FormatCurrency(props.row.pagoProvisionalIsr)
                            }}</q-td>
                        <q-td key="isrEnterado" :props="props">{{
                            FormatCurrency(props.row.isrEnterado)
                            }}</q-td>
                        <q-td key="isrAPagar" :props="props">{{
                            FormatCurrency(props.row.isrAPagar)
                            }}</q-td>
                    </template>
                    <q-td key="impuestoregistrado" :props="props">{{
                        FormatCurrency(props.row.impuestoregistrado)
                        }}</q-td>
                    <q-td key="comparativa" :props="props">{{
                        FormatCurrency(props.row.comparativa)
                        }}</q-td>
                </q-tr>
            </template>
        </q-table>
            ...
            itemsRegimen: [
                {
                    ...
                    tipoRegimen: "601 | General de Ley Personas Morales",
                },
                {
                    clave: "603",
                    descripcion: "Personas Morales con Fines no Lucrativos",
                    tipoRegimen: "603 | Personas Morales con Fines no Lucrativos",
                },
                {
                    clave: "605",
                ...
                },
                {
                    ...
                    tipoRegimen: "606 | Arrendamiento",
                },
                {
                    clave: "608",
                    descripcion: "Demás ingresos",
                    tipoRegimen: "608 | Demás ingresos",
                },
                {
                    clave: "609",
                    descripcion: "Consolidación",
                    tipoRegimen: "609 | Consolidación",
                },
                {
                    clave: "610",
                    descripcion:
                ...
                },
                {
                    ...
                    tipoRegimen: "611 | Ingresos por Dividendos (socios y accionistas)",
                },
                {
                    clave: "612",
                    descripcion:
                ...
                },
                {
                    ...
                    tipoRegimen: "614 | Ingresos por intereses",
                },
                {
                    clave: "616",
                    descripcion: "Sin obligaciones fiscales",
                    tipoRegimen: "616 | Sin obligaciones fiscales",
                },
                {
                    clave: "620",
                    descripcion:
                ...
                },
                {
                    ...
                    tipoRegimen: "621 | Incorporación Fiscal",
                },
                {
                    clave: "622",
                    descripcion:
                ...
                },
                {
                    ...
                    tipoRegimen: "623 | Opcional para Grupos de Sociedades",
                },
                {
                    clave: "624",
                    descripcion: "Coordinados",
                    tipoRegimen: "624 | Coordinados",
                },
                {
                    clave: "628",
                    descripcion: "Hidrocarburos",
                    tipoRegimen: "628 | Hidrocarburos",
                },
                {
                    clave: "607",
                    descripcion: "Régimen de Enajenación o Adquisición de Bienes",
                    tipoRegimen: "607 | Régimen de Enajenación o Adquisición de Bienes",
                },
                {
                    clave: "629",
                    descripcion:
                ...
                },
                {
                    ...
                    tipoRegimen: "630 | Enajenación de acciones en bolsa de valores",
                },
                {
                    clave: "615",
                    descripcion: "Régimen de los ingresos por obtención de premios",
                    tipoRegimen: "615 | Régimen de los ingresos por obtención de premios",
                },
                {
                    clave: "625",
                    descripcion:
                ...
                },
                {
                    ...
                    tipoRegimen: "626 | Régimen Simplificado de Confianza",
                },
            ],
            dialogRegimen: false,
...
>>>>>>> 669a6ee394515607e4a4977487ee176146a7ccaa
                ...
                let objetoTotales = {
                    mes: "Total",
                    ingresosPorMes: this.dataComprobantes.reduce(
                        (acumulador, objeto) => acumulador + objeto.ingresosPorMes,
                        0
                    ),
                    detalles: [],
                    ingresosAcumulados: this.dataComprobantes.reduce(
                        (acumulador, objeto) => acumulador + objeto.ingresosAcumulados,
                        0
                    ),
                    utilidadFiscal: this.dataComprobantes.reduce(
                        (acumulador, objeto) => acumulador + objeto.utilidadFiscal,
                        0
                    ),
                    basePagoProvisional: this.dataComprobantes.reduce(
                        (acumulador, objeto) => acumulador + objeto.basePagoProvisional,
                        0
                    ),
                    pagoProvisional: this.dataComprobantes.reduce(
                        (acumulador, objeto) => acumulador + objeto.pagoProvisional,
                        0
                    ),
                    impuestoCargo: this.dataComprobantes.reduce(
                        (acumulador, objeto) => acumulador + objeto.impuestoCargo,
                        0
                    ),
                    impuestoregistrado: this.dataComprobantes.reduce(
        ...
        async GetFisicaActividadEmpresarial() {
            ...
            try {
                ...
                this.dataComprobantes.forEach((item) => {
                    item.isrEmitido = 0;
                    item.isrDetalles = [];
                });
                ...
                // Convertimos ISR a mapa: MES_EN_LETRA -> ISR
                ...
                let objetoTotales = {
                    ...
                    detalles: [],
                    ingresosAcumulados: "---",
                    gastosPorMes: this.dataComprobantes.reduce(
                    ...
                    importeIsr: "---",
                    pagosAnteriores: "---",
                    isrEmitido: this.dataComprobantes.reduce(
                        (acumulador, objeto) => acumulador + objeto.isrEmitido,
                        0
                    ),
                    isrCargo: this.dataComprobantes.reduce(
                    ...
                    isrPagar: this.dataComprobantes.reduce(
        ...
        async GetResicoFisica() {
            ...
            try {
                ...
                // this.dataComprobantes.forEach((item) => {
                //   isrEmitido.forEach((a) => {
                //     if (item.mes === this.mesNumeroALetra(a.mes)) {
                //       item.isrEmitido = a.importe;
                //       item.isrDetalles = a.detalles;
                //     }
                //   });
                // });
                ...
                this.dataComprobantes.forEach((item) => {
                    ...
                    if (isr) {
                        item.isrEmitido = isr.importe ?? 0;
                        item.isrDetalles = isr.detalles ?? [];
                        item.isrPagar = item.importeIsr - isr.importe ?? 0;
                        item.comparativa = item.isrPagar - item.impuestoregistrado;
                    }
                });
                ...
                let objetoTotales = {
                    ...
                    importeIsr: this.dataComprobantes.reduce(
        ...
        ExportExcel() {
            ...
            let periodo =
                "ENERO A " + this.selectedMes.label + " " + this.selectedAnio;
        ...
        FormatCurrency(value) {
            if (value === "---") {
                ...
                let respuesta = value.toLocaleString("en-US", {
                    style: "currency",
                    currency: "USD",
                });
                return respuesta;
            ...
            try {
                let ObjData = {
                    ...
                    comparativa: [
                        {
                            mes: "ENERO",
                            importe: this.c_pfea.eneroFebrero,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                        ...
                        {
                            mes: "MARZO",
                            importe: this.c_pfea.marzoDiciembre,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
            ...
            try {
                let ObjData = {
                    ...
                    comparativa: [
                        {
                            mes: "ENERO",
                            importe: this.registrados.enero,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "FEBRERO",
                            importe: this.registrados.febrero,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "MARZO",
                            importe: this.registrados.marzo,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "ABRIL",
                            importe: this.registrados.abril,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "MAYO",
                            importe: this.registrados.mayo,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "JUNIO",
                            importe: this.registrados.junio,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "JULIO",
                            importe: this.registrados.julio,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "AGOSTO",
                            importe: this.registrados.agosto,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "SEPTIEMBRE",
                            importe: this.registrados.septiembre,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "OCTUBRE",
                            importe: this.registrados.octubre,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "NOVIEMBRE",
                            importe: this.registrados.noviembre,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                        {
                            mes: "DICIEMBRE",
                            importe: this.registrados.diciembre,
                            ivaCargo: 0,
                            ivaFavor: 0,
                        },
                    ],
